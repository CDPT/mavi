...
$("#btrestauraMaratonCompleto").click(function()
									  {
										  if(confirm("\n \n¿ Le gustaría borrar por compelto el maraton seleccionado esto borrará todo lo relacionado al maratón incluyendo preguntas respuestas y maraton activo?"))
										  {
											  	document.getElementById("Accion").value="borrarMaratonCompleto";
						document.primerForm.submit();
										  }
										  else
										  {
...
$("#btborrarMaratonCompleto").click(function()
									  {
										  if(confirm("\n \n¿ Le gustaría reiniciar por completo el maraton se borrara todo el avance ?"))
										  {
						if(!validaTexto("nombreMaraton","Falta nombre de maraton"))return;
