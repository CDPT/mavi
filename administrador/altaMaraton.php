<?	session_start();
	...
	echo (validarSession($_SESSION["nivel"],$ACCESO)?"":"<script>alert('Usted no cuenta con los permisos necesarios.'); window.location.href='../script/php/salir.php'</script>");
			...
			if($Accion =="borrarMaratonCompleto")
			{
			foreach($_POST as $nombre_campo => $valor)
			{
			$asignacion = "\$" . $nombre_campo . "='" . $valor . "';";
...
$consultaReactivoEJ=mysql_query($consultaReactivo);
            ...
            ?>
             ...
             <a href="#" class="button" id="btrestauraMaraton" name="btrestauraMaraton"><span>Borrar Sesion</span></a> 
            </div>
            <p>
           Nombre:
            &nbsp;
     ...
     ?>
             ...
             <a href="#" class="button" id="btrestauraMaratonCompleto" name="btrestauraMaratonCompleto"><span>Borrar </span></a> 
             <a href="#" class="button" id="btborrarMaratonCompleto" name="btborrarMaratonCompleto"><span>Restaurar </span></a>
</form>
            </span>
